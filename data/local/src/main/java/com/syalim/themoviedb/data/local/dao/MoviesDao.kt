package com.syalim.themoviedb.data.local.dao
...
interface MoviesDao {
   ...
   @Query("SELECT * FROM movies_home WHERE category =:category")
   ...
   @Query("DELETE FROM movies_home WHERE category=:category")
