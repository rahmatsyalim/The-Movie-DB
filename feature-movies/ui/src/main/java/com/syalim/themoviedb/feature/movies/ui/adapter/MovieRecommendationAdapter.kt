...
class MovieRecommendationAdapter @Inject constructor(
...
) : BaseAdapter<Movie, MovieRecommendationAdapter.MovieRecommendationViewHolder>(MovieDataComparator) {
   ...
   override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieRecommendationViewHolder {
      ...
      return MovieRecommendationViewHolder(itemBinding)
   }
   ...
   inner class MovieRecommendationViewHolder(private val binding: ItemMovieTvshowBinding) :
